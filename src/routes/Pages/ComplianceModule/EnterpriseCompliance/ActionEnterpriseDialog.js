...
import {complyEnterpriseCompliance, fetchEnterpriseCompliance, fetchEnterpriseComplianceComplied, fetchEnterpriseComplianceMain} from "../../../../redux/actions/Compliance";
...
const ActionEnterpriseDialog = props => {
    ...
    const getContent = () => {
        ...
        return (
            <>
                <Typography>
                    Are you sure you want to waive now?
                </Typography>
                <TextField
                    margin={'normal'}
                    fullWidth
            ...
            <Dialog open={open} onClose={onClose} maxWidth={'sm'} fullWidth={true}>
                <DialogTitle>
                    <Box sx={{ display: 'flex', justifyContent:'space-between', alignItems: 'center'}}>
                        <Typography color={'primary.main'} variant={'h6'}>Confirmation</Typography>
                ...
                <DialogContent>
                    <form onSubmit={handleOnSubmit}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent:'flex-end', alignItems:'center', mt:2}}>
                            <Button variant={'outlined'} sx={{ mr:2}} type={'submit'}>Yes, Proceed</Button>
