...
const AddEditEnterpriseCompliance = () => {
  ...
  const handleOnSave = async e => {
    ...
    if (isUpdate) {
      await dispatch(updateEnterpriseCompliance(data, () => handleNext()));
      await dispatch(fetchEnterpriseComplianceSub({ id: selectedEnterprise }));
    } else {
      await dispatch(addEnterpriseCompliance(data, () => handleNext()));
      await dispatch(fetchEnterpriseComplianceSub({ id: selectedEnterprise }));
    }
  };
  const handlePrev = () => {
...
export const ComplianceContent = props => {
  ...
  const { mainEnterpriseComplianceData } = useSelector(({ compliance }) => compliance);

  const hasSubComplianceData = mainEnterpriseComplianceData.filter(
          ...
          <tr>
            ...
            <td className={classes.td}>
              {complianceDetails.organization.map(org => {
                ...
                return (
                  <>
                    <li key={org.id}>{org.sectionName}</li>
                  </>
                );
              })}
            </td>
          ...
          <tr>
            ...
            <td className={classes.td}>
              {complianceDetails.organization.map(org => {
                ...
                return (
                  <>
                    <li key={org.id}>{org.subSectionName}</li>
                  </>
                );
              })}
            </td>
