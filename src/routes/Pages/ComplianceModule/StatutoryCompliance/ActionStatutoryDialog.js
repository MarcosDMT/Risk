...
import { complyStatutoryCompliance } from '../../../../redux/actions/Compliance';
...
const ActionEnterpriseDialog = props => {
  ...
  const handleOnSubmit = async e => {
    e.preventDefault();
    await dispatch(complyStatutoryCompliance(formDetails, () => onClose()));
    await dispatch(fetchStatutoryComplianceSub(compliance?.mainId))
...
export default React.memo(ActionEnterpriseDialog);
