...
import { SIDEBAR_WIDTH } from '../../../../@jumbo/constants/ThemeOptions';
...
const LayoutContextProvider = props => {
  ...
  const [sidebarWidth, setSidebarWidth] = useState(props.sidebarWidth ? props.sidebarWidth : SIDEBAR_WIDTH.SMALL);
